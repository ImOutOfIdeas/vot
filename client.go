...
func main() {
	...
	istream, err := portaudio.OpenDefaultStream(1, 0, 44100, 1024,
	...
	output_channel := make(chan []int16, 10)

	// Create output stream with playback callback closure
	ostream, err := portaudio.OpenDefaultStream(0, 1, 44100, 1024,
